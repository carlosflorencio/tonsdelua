...
var _Row = require('./modules/Row.vue');
...
},{"./modules/Row.vue":7,"vue":3}],6:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/home/carlos/sites/tons_de_lua/resources/assets/js/backend/modules/Col.vue"
...
exports.default = {
    ...
    computed: {
        kclass: function kclass() {
            var n = 12 / this.row.cols.length;
            return "col-md-" + n;
        }
    },
    methods: {
        removeLine: function removeLine(row) {
            this.$dispatch('remove-row', row);
        },
        removeCol: function removeCol(col) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/home/carlos/sites/tons_de_lua/resources/assets/js/backend/modules/Row.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"./Col.vue":6,"vue":3,"vue-hot-reload-api":2}]},{},[5]);
